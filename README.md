...
1. **Revenue/Demand Forecasting** – Build ML models to predict future sales and demand patterns
2. **Liquidity Simulation** – Derive working capital metrics (DSO, DPO, cash conversion cycle) using realistic financial ratios
3. **Liquidity Risk Classification** – Classify liquidity status as Safe / At Risk / Critical
4. **Interactive Dashboard** – Deliver a Streamlit-based decision support tool for financial planning
...
- **Inventory Days**: Applied to COGS to estimate Inventory balance
- **Cash Balance**: Calculated from cash inflows/outflows based on above metrics

All formulas and assumptions are documented in `config/settings.yaml` and notebooks.
...
cd "AML project-20251017T051331Z-1-001"
